...
class GameController extends Notifier<GameState> {
  ...
  GameState _initialState() {
    ...
    final lg = const League(id: "pt2", name: "Segunda Liga", multiplier: 1.00);
  ...
  void train(String playerId, String skillId) {
    ...
    // Notify training improvement (if we can read the skill level)
  ...
  void restAll() {
    ...
    _notify('Training', SkillMessages.squadRested());
  }
